...
EAPI const Eo_Class *edje_object_class_get(void) EINA_CONST;
 ...
 * @ingroup Edje_Object
 */
EOAPI void  edje_obj_language_set(const char *language);
 ...
 * @ingroup Edje_Object
 */
EOAPI const char * edje_obj_language_get(void);
 ...
 *
 * See also @ref edje_obj_animation_get()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_animation_set().
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_play_get().
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_play_set().
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * @ref edje_object_perspective_new() See also @ref edje_obj_perspective_get()
 ...
 *
 * See also @ref edje_obj_perspective_set()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_scale_get() @ref edje_scale_get() for more details
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * object.
 *
 * See also @ref edje_obj_scale_set() for more details
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_message_send()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_size_max_get()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * pointed variables be set to zero.
 *
 * See also @ref edje_obj_size_min_get()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * @ingroup Edje_Object
 */
EOAPI Eina_Bool  edje_obj_size_class_set(const char * size_class, int minw, int minh, int maxw, int maxh);
 ...
 * @ingroup Edje_Object
 */
EOAPI Eina_Bool  edje_obj_size_class_get(const char * size_class, int *minw, int *minh, int *maxw, int *maxh);
 ...
 * @ingroup Edje_Object
 */
EOAPI void  edje_obj_transition_duration_factor_set(double scale);
 ...
 * @ingroup Edje_Object
 */
EOAPI double  edje_obj_transition_duration_factor_get(void);
 ...
 * @ingroup Edje_Object
 */
EOAPI Eina_Bool  edje_obj_part_text_min_policy_set(const char * part, const char * state_name, Eina_Bool min_x, Eina_Bool min_y);
 ...
 * @ingroup Edje_Object
 */
EOAPI Eina_Bool  edje_obj_part_text_min_policy_get(const char * part, const char * state_name, Eina_Bool *min_x, Eina_Bool *min_y);
 ...
 * @internal
 *
 * @brief Enables selection if the entry is an EXPLICIT
 * selection mode type.
 *
 * The default is to  not allow selection. This function only affects user
 * selection, functions such as edje_object_part_text_select_all() and
 ...
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] disable true to enable, false otherwise
 *
 * @ingroup Edje_Object
 */
EOAPI void  edje_obj_part_text_select_disable_set(const char *part, Eina_Bool disable);
 ...
 *
 * See also @ref edje_obj_text_markup_filter_callback_add and
 * @ref edje_obj_text_markup_filter_callback_del
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 ...
 * be moved.
 *
 * See also @ref edje_obj_part_drag_step_get()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_drag_step_set()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * This function removes a callback, previously attached to the emittion of a
 * signal, from the object  obj. The parameters emission,  source and  func
 * must match exactly those passed to a previous call to
 * edje_object_signal_callback_add(). The data pointer that was passed to this
 * call will be returned.
 *
 * See also @ref edje_obj_signal_callback_add(). @ref
 ...
 * @ref edje_obj_part_text_input_panel_show
 *
 ...
 * Returns the user data pointer given when added.
 *
 * See also @ref edje_obj_text_insert_filter_callback_add and
 * @ref edje_obj_text_insert_filter_callback_del
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] func The function callback to remove
 ...
 *
 * See also @ref edje_obj_part_box_remove() and
 * @ref edje_obj_part_box_remove_all()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_drag_value_get()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * the relative position to the dragable area on that axis.
 *
 * See also @ref edje_obj_part_drag_value_set()
 *
 ...
 *
 * See also @ref edje_obj_part_text_input_panel_layout_set
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] part The part name
 ...
 *
 * See also @ref edje_obj_part_text_input_panel_language_set for more details.
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] part The part name
 ...
 * also @ref edje_obj_part_text_input_panel_enabled_set
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] part The part name
 ...
 *
 * See also @ref edje_obj_part_box_append(), @ref edje_obj_part_box_prepend()
 * and @ref edje_obj_part_box_insert_before()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * be moved.
 *
 * See also @ref edje_obj_part_drag_page_get()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_drag_page_set()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_box_append(),
 * @ref edje_obj_part_box_insert_before() and
 * @ref edje_obj_part_box_insert_at()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * for EDC files).
 *
 * See also @ref edje_obj_signal_callback_add() for more on Edje signals.
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_text_input_panel_layout_variation_set
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] part The part name
 ...
 *
 * See also @ref edje_obj_part_drag_size_get()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_drag_size_set()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_text_insert_filter_callback_add and
 * @ref edje_obj_text_insert_filter_callback_del_full
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] func The function callback to remove
 ...
 * TEXTBLOCK.
 *
 * See also @ref edje_obj_part_text_unescaped_get().
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_text_unescaped_set().
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 * @param[in] part The part name
 ...
 * @ref edje_obj_signal_emit() on how to emits Edje signals from code to a an
 * object @ref edje_object_signal_callback_del_full()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 * @param[in] source The signal's "source" string
 ...
 *
 * See also @ref edje_obj_text_markup_filter_callback_del,
 * @ref edje_obj_text_markup_filter_callback_del_full and
 * @ref edje_obj_text_insert_filter_callback_add
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_box_remove_at() and
 * @ref edje_obj_part_box_remove_all()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_text_input_panel_return_key_type_set() for more
 * details
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_box_append(), @ref edje_obj_part_box_prepend()
 * and @ref edje_obj_part_box_insert_at()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 * @param[in] child The object to insert
 ...
 *
 * See also @ref edje_obj_part_box_prepend(),
 * @ref edje_obj_part_box_insert_before() and
 * @ref edje_obj_part_box_insert_at()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 ...
 *
 * See also @ref edje_obj_part_box_remove() and
 * @ref edje_obj_part_box_remove_at()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_drag_step()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 *
 * See also @ref edje_obj_part_text_set().
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 * @param[in] part The part name
 ...
 *
 * See also @ref edje_obj_part_text_select_all() and
 * @ref edje_obj_part_text_select_none()
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] part The part name
 ...
 * @ingroup Edje_Object
 */
EOAPI Eina_Bool  edje_obj_text_class_get(const char *text_class, const char **font, Evas_Font_Size *size);
 ...
 * @ingroup Edje_Object
 */
EOAPI const char * edje_obj_color_class_description_get(const char *color_class);
 ...
 * @ingroup Edje_Object
 */
EOAPI Eina_Bool  edje_obj_color_class_clear(void);
 ...
 * @ingroup Edje_Object
 */
EOAPI void  edje_obj_color_class_parent_set(Evas_Object *parent);

/**
 * @internal
 *
 * @brief Unsets the parent object color class.
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @ingroup Edje_Object
 */
EOAPI void  edje_obj_color_class_parent_unset(void);
 ...
 * @ingroup Edje_Object
 */
EOAPI void  edje_obj_size_class_del(const char *size_class);
 ...
 * Values for dx and dy are real numbers that range from 0 to 1.
 *
 * See also @ref edje_obj_part_drag_page()
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 * @param[in] dx The x step
 ...
 * @ingroup Edje_Object
 */
EOAPI void  edje_obj_part_text_cursor_on_mouse_geometry_get(const char *part, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
 ...
 * executed, and then filtered text will be inserted.
 *
 * See also @ref edje_obj_text_insert_filter_callback_del,
 * @ref edje_obj_text_insert_filter_callback_del_full and
 * @ref edje_obj_text_markup_filter_callback_add
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 ...
 *
 * See also @ref edje_obj_text_markup_filter_callback_add and
 * @ref edje_obj_text_markup_filter_callback_del_full
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 *
 * @param[in] func The function callback to remove
...
/**
 * @brief Hide visible last character for password mode.
 *
 * @param[in] part The part name
 *
 ...
 * @ingroup Edje_Object
 */
EOAPI Eina_Bool  edje_obj_part_text_hide_visible_password(const char *part);

EOAPI extern const Eo_Event_Description _EDJE_OBJECT_EVENT_RECALC;

/** Edje re-calculated the object.
 *
 * @ingroup Edje_Object
 */
#define EDJE_OBJECT_EVENT_RECALC (&(_EDJE_OBJECT_EVENT_RECALC))

 ...
 * @ingroup Evas_Canvas
 */
EOAPI void  evas_canvas_render_copy(void *buffer, int stride, int width, int height, unsigned int format, int sx, int sy, int sw, int sh, int dx, int dy, int dw, int dh);
 ...
 * @ingroup Evas_Canvas
 */
EOAPI void  evas_canvas_event_feed_mouse_down_with_multi_info(int b, Evas_Button_Flags flags, unsigned int timestamp, const void *data, double rad, double radx, double rady, double pres, double ang);
 ...
 * @ingroup Evas_Canvas
 */
EOAPI void  evas_canvas_event_feed_mouse_up_with_multi_info(int b, Evas_Button_Flags flags, unsigned int timestamp, const void *data, double rad, double radx, double rady, double pres, double ang);
 ...
 * @ingroup Evas_Canvas
 */
EOAPI void  evas_canvas_event_input_mouse_move_with_multi_info(int x, int y, unsigned int timestamp, const void *data, double rad, double radx, double rady, double pres, double ang);

...
typedef enum
{
  EVAS_TEXTGRID_FONT_STYLE_NORMAL = 1 /* 0 << 0 */, /** Normal style */
  EVAS_TEXTGRID_FONT_STYLE_BOLD = 2 /* 0 << 0 */, /** Bold style */
  EVAS_TEXTGRID_FONT_STYLE_ITALIC = 4 /* 0 << 0 */ /** Oblique style */
 ...
 *
 * See also @ref Efl.Text_Properties.font.set and

...
EAPI const Eo_Class *evas_box_class_get(void) EINA_CONST;
 ...
 *
 * @return @c ture on success, @c false on failure.
 *
 * @ingroup Evas_Box
 */
 ...
 * of text as an analogy). A row has as much elements as can fit into the box's

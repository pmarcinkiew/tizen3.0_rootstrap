 ...
 * @internal
 *
 * @brief Set the number of items to cache, on a given
 * slideshow widget, after the current item.
 *
 ...
 * @internal
 *
 * @brief Get the number of items to cache, on a given
 * slideshow widget, after the current item.
 *
 ...
 *
 * @brief Set the number of items to cache, on a given
 * slideshow widget, before the current item.
 *
 * The default value for this property is 2. See @ref Slideshow_Caching
 * "slideshow caching" for more details.
 *
 ...
 * @internal
 *
 * @brief Set the current slide layout in use for a given
 * slideshow widget
 *
 ...
 * @internal
 *
 * @brief Get the current slide layout in use for a given
 * slideshow widget.
 *
 ...
 * @internal
 *
 * @brief Set the current slide transition/effect in use for
 ...
 * @internal
 *
 * @brief Get the current slide transition/effect in use for
 * a given slideshow widget.
 *
 ...
 * @internal
 *
 * @brief Set if, after a slideshow is started, for a given
 * slideshow widget, its items should be displayed cyclically or not.
 *
 * @note @ref elm_slideshow_next and @ref elm_slideshow_previous will ignore
 * what is set by this functions, i.e., they'll always cycle through items.
 * This affects only the "automatic" slideshow, as set by
 * @ref elm_slideshow_timeout_set.
 *
 ...
 * @internal
 *
 * @brief Get if, after a slideshow is started, for a given
 * slideshow widget, its items are to be displayed cyclically or not.
 *
 ...
 * @internal
 *
 * @brief Set the interval between each image transition on a
 * given slideshow widget and start the slideshow itself.
 *
 ...
 * @internal
 *
 * @brief Get the interval set for image transitions on a
 ...
 * @internal
 *
 * @brief Get the internal list of items in a given slideshow
 * widget.
 *
 ...
 * @internal
 *
 * @brief Returns the list of sliding transition/effect names
 * available, for a given slideshow widget.
 *
 ...
 * @internal
 *
 * @brief Get the number of items stored in a given slideshow
 * widget.
 *
 ...
 * @internal
 *
 * @brief Returns the currently displayed item, in a given
 * slideshow widget.
 *
 ...
 * @internal
 *
 * @brief Returns the list of layout names available, for a
 * given slideshow widget.
 *
 ...
 * @internal
 *
 * @brief Slide to the previous item, in a given slideshow
 * widget
 *
 ...
 * @internal
 *
 * @brief Slide to the next item, in a given slideshow
 * widget.
 *
 * The sliding animation @c obj is set to use will be the transition effect
 * used, after this call is issued.
 ...
 * @internal
 *
 * @brief Add (append) a new item in a given slideshow
 * widget.
 *
 ...
 * @internal
 *
 * @brief Insert a new item into the given slideshow widget,
 * using the @c func function to sort items (by item handles).
 *

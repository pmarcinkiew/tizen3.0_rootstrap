 ...
 * @ingroup Elm_Diskselector
 */
EOAPI Elm_Widget_Item * elm_obj_diskselector_first_item_get(void);
 ...
 * @ingroup Elm_Diskselector
 */
EOAPI Elm_Widget_Item * elm_obj_diskselector_last_item_get(void);
 ...
 * @ref elm_obj_diskselector_selected_item_set, and the first item of
 ...
 * @ingroup Elm_Diskselector
 */
EOAPI Elm_Widget_Item * elm_obj_diskselector_selected_item_get(void);
 ...
 * @ingroup Elm_Diskselector
 */
EOAPI Elm_Widget_Item * elm_obj_diskselector_item_append(const char *label, Evas_Object *icon, Evas_Smart_Cb func, const void *data);

 ...
 * @ref elm_obj_layout_box_remove for all box children.
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * will be deleted automatically. One should use @ref elm_obj_layout_box_remove
 ...
 * deleted automatically. One should use @ref elm_obj_layout_table_unpack to
 ...
 *
 * See also @ref elm_obj_layout_table_unpack, @ref elm_obj_layout_table_clear.
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 ...
 * @ref elm_obj_layout_table_unpack for all table children.
 *
 * @if MOBILE @since_tizen 2.3 @elseif WEARABLE @since_tizen 2.3.1 @endif
 *
 * @param[in] clear If true, then all objects will be deleted as well,

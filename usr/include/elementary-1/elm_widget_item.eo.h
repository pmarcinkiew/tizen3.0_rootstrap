 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI Eina_Bool  elm_wdg_item_class_color_set(const char * color_class, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI Eina_Bool  elm_wdg_item_class_color_get(const char * color_class, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI Eina_Bool  elm_wdg_item_class_color2_set(const char * color_class, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI Eina_Bool  elm_wdg_item_class_color2_get(const char * color_class, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI Eina_Bool  elm_wdg_item_class_color3_set(const char * color_class, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI Eina_Bool  elm_wdg_item_class_color3_get(const char * color_class, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI void  elm_wdg_item_class_color_del(const char *color_class);
 ...
 * @ingroup Elm_Widget_Item
 */
EOAPI void  elm_wdg_item_class_color_clear(void);

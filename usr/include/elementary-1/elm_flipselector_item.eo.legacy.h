 ...
 * @brief @MOBILE_ONLY
 *
 * Set whether a given flip selector widget's item should be the currently
 * selected one.
 *
 ...
 * @brief @MOBILE_ONLY
 *
 * Get whether a given flip selector widget's item is the currently selected
 * one.
 *
 ...
 * @brief @MOBILE_ONLY
 *
 * Get the item before @c item in a flip selector widget's internal list of
 * items.
 *
 ...
 * @brief @MOBILE_ONLY
 *
 * Get the item after @c item in a flip selector widget's internal list of
 * items.
 *

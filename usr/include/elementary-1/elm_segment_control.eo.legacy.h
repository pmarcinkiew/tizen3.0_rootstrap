 ...
 * @ingroup Elm_Segment_Control
 */
EAPI Elm_Widget_Item *elm_segment_control_item_insert_at(Elm_Segment_Control *obj, Evas_Object *icon, const char *label, int idx);
 ...
 * @ingroup Elm_Segment_Control
 */
EAPI Elm_Widget_Item *elm_segment_control_item_add(Elm_Segment_Control *obj, Evas_Object *icon, const char *label);
 ...
 * @ingroup Elm_Segment_Control
 */
EAPI Evas_Object *elm_segment_control_item_icon_get(const Elm_Segment_Control *obj, int idx);

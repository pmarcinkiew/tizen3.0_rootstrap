 ...
 * @internal
 *
 * @brief Set whether a given file selector entry widget's
 ...
 * @internal
 *
 * @brief Get whether a given file selector entry widget's
 * internal file selector will raise an Elementary "inner window", instead of a
 ...
 * @internal
 *
 * @brief Set the size of a given file selector entry
 ...
 * @internal
 *
 * @brief Get the size of a given file selector entry
 * widget's window, holding the file selector itself.
 *
 ...
 * @internal
 *
 * @brief Set the title for a given file selector entry
 * widget's window
 *
 ...
 * @internal
 *
 * @brief Get the title set for a given file selector entry
 * widget's window.
 *

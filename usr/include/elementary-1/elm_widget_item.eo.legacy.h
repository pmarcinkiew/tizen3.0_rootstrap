 ...
 * @ingroup Elm_Widget_Item
 */
EAPI void elm_object_item_part_content_set(Elm_Widget_Item *obj, const char * part, Evas_Object *content);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Evas_Object *elm_object_item_part_content_get(const Elm_Widget_Item *obj, const char * part);
...
/**
 * @brief Set the color of color class for the Elementary widget item.
 *
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Eina_Bool elm_object_item_color_class_color_set(Elm_Widget_Item *obj, const char * color_class, int r, int g, int b, int a);

/**
 * @brief Get the color of color class for the Elementary widget item.
 *
 * @note These color values are expected to be premultiplied by @p a.
 *
 * @if MOBILE @since_tizen 3.0 @elseif WEARABLE @since_tizen 3.0 @endif
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Eina_Bool elm_object_item_color_class_color_get(const Elm_Widget_Item *obj, const char * color_class, int *r, int *g, int *b, int *a);

/**
 * @brief Set the second color of color class for the Elementary widget item.
 *
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Eina_Bool elm_object_item_color_class_color2_set(Elm_Widget_Item *obj, const char * color_class, int r, int g, int b, int a);

/**
 * @brief Get the second color of color class for the Elementary widget item.
 *
 * The second color is commonly used for outline of text.
 *
 * @note These color values are expected to be premultiplied by @p a.
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Eina_Bool elm_object_item_color_class_color2_get(const Elm_Widget_Item *obj, const char * color_class, int *r, int *g, int *b, int *a);

/**
 * @brief Set the third color of color class for the Elementary widget item.
 *
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Eina_Bool elm_object_item_color_class_color3_set(Elm_Widget_Item *obj, const char * color_class, int r, int g, int b, int a);

/**
 * @brief Get the third color of color class for the Elementary widget item.
 *
 * The third color is commonly used for shadow of text.
 *
 * @note These color values are expected to be premultiplied by @p a.
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Eina_Bool elm_object_item_color_class_color3_get(const Elm_Widget_Item *obj, const char * color_class, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI const Eina_List *elm_object_item_access_order_get(const Elm_Widget_Item *obj);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Evas_Object *elm_object_item_widget_get(const Elm_Widget_Item *obj);

/** Delete the given item.
 *
 * @ingroup Elm_Widget_Item
 */
EAPI void elm_object_item_del(Elm_Widget_Item *obj);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Evas_Object *elm_object_item_part_content_unset(Elm_Widget_Item *obj, const char *part);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Evas_Object *elm_object_item_access_object_get(const Elm_Widget_Item *obj);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Evas_Object *elm_object_item_track(Elm_Widget_Item *obj);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Evas_Object *elm_object_item_access_register(Elm_Widget_Item *obj);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Evas_Object *elm_object_item_focus_next_object_get(const Elm_Widget_Item *obj, Elm_Focus_Direction dir);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI void elm_object_item_focus_next_object_set(Elm_Widget_Item *obj, Evas_Object *next, Elm_Focus_Direction dir);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI Elm_Object_Item *elm_object_item_focus_next_item_get(const Elm_Widget_Item *obj, Elm_Focus_Direction dir);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI void elm_object_item_focus_next_item_set(Elm_Widget_Item *obj, Elm_Object_Item *next_item, Elm_Focus_Direction dir);
 ...
 * @ingroup Elm_Widget_Item
 */
EAPI void elm_object_item_color_class_del(Elm_Widget_Item *obj, const char *color_class);

/**
 * @brief Delete all color classes for the Elementary widget item.
 *
 * This function deletes any color classes defined for the Elementary widget
 * item. Clearing color classes will revert the color of all parts to the
 * values defined by elm_color_class_set() or the theme file.
 *
 * @ingroup Elm_Widget_Item
 */
EAPI void elm_object_item_color_class_clear(Elm_Widget_Item *obj);

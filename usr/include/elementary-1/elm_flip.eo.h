#ifndef _ELM_FLIP_EO_H_
#define _ELM_FLIP_EO_H_
...
#endif
#define ELM_FLIP_CLASS elm_flip_class_get()

EAPI const Eo_Class *elm_flip_class_get(void) EINA_CONST;
 ...
 * size) with @ref @ref elm_obj_flip_interaction_direction_enabled_set and
 * @ref elm_obj_flip_interaction_direction_hitsize_set.
 *
 ...
 * happen, those can only be achieved with @ref elm_obj_flip_go.
 *
 ...
 *
 * See also @ref elm_obj_flip_interaction_set.
 *
 * @if MOBILE @since_tizen 2.3 @endif
 *
 ...
 * @ref elm_obj_flip_interaction_direction_hitsize_set. By default, a minimum
...
EOAPI extern const Eo_Event_Description _ELM_FLIP_EVENT_ANIMATE_BEGIN;
EOAPI extern const Eo_Event_Description _ELM_FLIP_EVENT_ANIMATE_DONE;

/**
 * No description
 */
#define ELM_FLIP_EVENT_ANIMATE_BEGIN (&(_ELM_FLIP_EVENT_ANIMATE_BEGIN))

/**
 * No description
 */
#define ELM_FLIP_EVENT_ANIMATE_DONE (&(_ELM_FLIP_EVENT_ANIMATE_DONE))

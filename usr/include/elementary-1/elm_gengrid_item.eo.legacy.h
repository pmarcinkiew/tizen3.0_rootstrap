 ...
 * @ingroup Elm_Gengrid_Item
 */
EAPI void elm_gengrid_item_custom_size_set(Elm_Gengrid_Item *obj, Evas_Coord w, Evas_Coord h);
 ...
 * @ingroup Elm_Gengrid_Item
 */
EAPI void elm_gengrid_item_custom_size_get(const Elm_Gengrid_Item *obj, Evas_Coord *w, Evas_Coord *h);

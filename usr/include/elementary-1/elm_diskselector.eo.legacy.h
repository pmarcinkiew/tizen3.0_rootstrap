 ...
 * @ref elm_diskselector_selected_item_set, and the first item of diskselector
 * will be selected.
 *
 ...
 * @ingroup Elm_Diskselector
 */
EAPI Elm_Widget_Item *elm_diskselector_item_append(Elm_Diskselector *obj, const char *label, Evas_Object *icon, Evas_Smart_Cb func, const void *data);
